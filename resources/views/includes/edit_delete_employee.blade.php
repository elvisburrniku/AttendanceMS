<!-- Edit -->
<div class="modal fade" id="edit{{ $employee->first_name }}">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body text-left">
                <form class="form-horizontal" method="POST" action="{{ route('employees.update', $employee->first_name) }}">
                    @csrf
...
<!-- Delete -->
<div class="modal fade" id="delete{{ $employee->first_name }}">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="{{ route('employees.destroy', $employee->first_name) }}">
                    @csrf
                    {{ method_field('DELETE') }}
