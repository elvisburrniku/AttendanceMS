            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="mb-0">Create Time Interval</h4>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('time-intervals.store') }}">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="alias" id="alias" class="form-control" 
                                           value="{{ old('alias') }}" required placeholder="e.g., Morning Shift">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="time" name="in_time" id="in_time" class="form-control" 
                                           value="{{ old('in_time', '09:00') }}" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="duration" id="duration" class="form-control" 
                                           value="{{ old('duration', 480) }}" required min="1" max="1440">
                                    <small class="form-text text-muted">480 minutes = 8 hours</small>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="in_ahead_margin" id="in_ahead_margin" class="form-control" 
                                           value="{{ old('in_ahead_margin', 15) }}" min="0">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="in_above_margin" id="in_above_margin" class="form-control" 
                                           value="{{ old('in_above_margin', 10) }}" min="0">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="out_ahead_margin" id="out_ahead_margin" class="form-control" 
                                           value="{{ old('out_ahead_margin', 10) }}" min="0">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="out_above_margin" id="out_above_margin" class="form-control" 
                                           value="{{ old('out_above_margin', 30) }}" min="0">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="allow_leave_early" id="allow_leave_early" class="form-control" 
                                           value="{{ old('allow_leave_early', 10) }}" min="0">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="work_day" id="work_day" class="form-control" 
                                           value="{{ old('work_day', 1) }}" min="0" max="1" step="0.1">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="enable_early_in" 
                                           id="enable_early_in" {{ old('enable_early_in') ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="enable_late_out" 
                                           id="enable_late_out" {{ old('enable_late_out') ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="enable_overtime" 
                                           id="enable_overtime" {{ old('enable_overtime') ? 'checked' : '' }}>
                        ...
                        <div class="row" id="overtime_settings" style="display: none;">
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="enable_max_ot_limit" 
                                           id="enable_max_ot_limit" {{ old('enable_max_ot_limit') ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="max_ot_limit" id="max_ot_limit" class="form-control" 
                                           value="{{ old('max_ot_limit', 120) }}" min="0">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="count_early_in_interval" 
                                           id="count_early_in_interval" {{ old('count_early_in_interval') ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="count_late_out_interval" 
                                           id="count_late_out_interval" {{ old('count_late_out_interval') ? 'checked' : '' }}>
                        ...
                        <div class="form-group mt-3">
                            <button type="submit" class="btn btn-primary">
                                <i class="fa fa-save"></i> Create Time Interval
                            </button>
